...
function Container2() {
  return (
    <div className="content-stretch flex flex-col font-['Inter:Regular',_'Noto_Sans_Arabic:Regular',_sans-serif] font-normal gap-[3.995px] h-[55.983px] items-end not-italic relative shrink-0 text-nowrap text-right w-full whitespace-pre" data-name="Container">
      <p className="leading-[32px] relative shrink-0 text-[24px] text-white tracking-[0.0703px]" dir="auto">
        فارسی
      </p>
      <p className="leading-[20px] relative shrink-0 text-[14px] text-[rgba(255,255,255,0.6)] tracking-[-0.1504px]" dir="auto">
        شعر کلاسیک
      </p>
    </div>
  );
...
function Button() {
  return (
    <div className="bg-[rgba(0,0,0,0.4)] h-[105.019px] relative rounded-[16px] shrink-0 w-full" data-name="Button">
      <div className="flex flex-col items-end overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col h-[105.019px] items-end pb-[0.522px] pt-[24.518px] px-[24.518px] relative w-full">
          <Container2 />
        </div>
      </div>
...
function Container3() {
  return (
    <div className="content-stretch flex flex-col font-['Inter:Regular',_sans-serif] font-normal gap-[3.995px] h-[55.983px] items-start not-italic relative shrink-0 text-nowrap w-full whitespace-pre" data-name="Container">
      <p className="leading-[32px] relative shrink-0 text-[24px] text-white tracking-[0.0703px]">English</p>
      <p className="leading-[20px] relative shrink-0 text-[14px] text-[rgba(255,255,255,0.6)] tracking-[-0.1504px]">Translated Poetry</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-[rgba(0,0,0,0.4)] h-[105.019px] relative rounded-[16px] shrink-0 w-full" data-name="Button">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col h-[105.019px] items-start pb-[0.522px] pt-[24.518px] px-[24.518px] relative w-full">
          <Container3 />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[0.522px] border-[rgba(255,255,255,0.1)] border-solid inset-0 pointer-events-none rounded-[16px]" />
...
export default function WelcomeScreen() {
  return (
    <div className="bg-black content-stretch flex flex-col gap-[10px] items-center justify-center relative size-full" data-name="WelcomeScreen">
      <Container />
      <p className="absolute bottom-[722px] font-['Noto_Nastaliq_Urdu:Medium',_sans-serif] font-medium leading-[48px] left-[calc(50%-86.5px)] text-[48px] text-neutral-50 text-nowrap top-[162px] tracking-[0.0508px] whitespace-pre" dir="auto">
        رباعی وتار
      </p>
